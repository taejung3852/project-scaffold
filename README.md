...
[NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)는 스킬 기반 자가 진화 AI 에이전트 하네스다. 에이전트가 오래 쓰일수록 스킬이 누적되고, 중복이 생기고, 사용 패턴이 바뀐다. Hermes는 이 문제를 **4개의 Python 레이어**로 해결한다.
